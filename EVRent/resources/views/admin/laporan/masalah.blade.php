...
@section('title', 'Laporan Masalah Pengguna')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Laporan Masalah Pengguna</h1>
    ...
    @if($reports->isEmpty())
        <div class="bg-white shadow-sm rounded-xl p-12 text-center border border-gray-100">
            ...
            <p class="mt-2 text-sm text-gray-500">Saat ini belum ada pengguna yang melaporkan masalah.</p>
        </div>
    @else
        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex flex-col space-y-1 sm:flex-row sm:space-y-0 sm:space-x-4 text-sm text-gray-500">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        {{ $report->pemesanan->kendaraan->pemilik->nama_rental ?? 'Unknown Rental' }}
                                    </div>
                                    <div class="flex items-center">
