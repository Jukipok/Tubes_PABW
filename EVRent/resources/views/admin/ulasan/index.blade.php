...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @if($reviews->isEmpty())
        <div class="bg-white shadow rounded-lg p-10 text-center">
            <p class="text-gray-500">Belum ada ulasan dari pengguna.</p>
        </div>
    @else
                    ...
                    <div class="px-4 py-4 sm:px-6">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-600">
                                <span class="font-medium text-gray-900">Ke Rental:</span> {{ $review->pemilikRental->nama_rental ?? 'Unknown Rental' }}
                            </p>
