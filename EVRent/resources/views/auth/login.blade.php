...
@section('title', 'Login - EVRent')

@section('content')
<div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full bg-white rounded-lg shadow-xl p-8 space-y-8 glass">
        <div>
        ...
        <form class="mt-8 space-y-6" action="{{ route('login.post') }}" method="POST">
            ...
            <div class="text-center text-sm">
                Belum punya akun? <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-500">Daftar disini</a>
            </div>
        </form>
    </div>
</div>
